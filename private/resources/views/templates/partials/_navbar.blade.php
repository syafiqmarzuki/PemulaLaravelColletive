<div class="topbar">
		...
		<div class="topbar-left">
			<a href="index.html" class="logo"><span><img src="{{ asset('public/assets/images/logo-light.png')}}" alt="" height="18"></span><i><img src="{{ asset('public/assets/images/logo-sm1.png')}}" alt="" height="22"></i></a>
		</div>
